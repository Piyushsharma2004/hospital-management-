...
import { FaFileMedicalAlt, FaProcedures, FaChartLine, FaUtensils } from "react-icons/fa";
import { MdLocalHospital, MdMedicalServices, MdElectricBolt } from "react-icons/md";
...
const menuGroups = [
  {
    menuItems: [
      ...
      },
      {
        ...
        label: "X-Ray Machine",
        route: "/Dashboard/x-ray-machine",
        pro: true,
      },
      {
        icon: (
          <FaFileMedicalAlt className="w-6 h-6"/>
        ),
        label: "X-Ray analyzer",
        route: "/Dashboard/x-ray-analyzer",
        pro: true,
      },
      ...
      },
      {
        ...
        route: "/Dashboard/Food-nutrition-analyzer",
      },
      
      {
        ...
        route: "/Dashboard/Health-insights",
      },
      {
        icon: (
          <MdElectricBolt className="w-6 h-6"/>
        ),
        label: "Mental Health Analyzer",
    ...
    menuItems: [
      {
        ...
        label: "Test Model(Try this)",
        route: "/Dashboard/ml-model-test",
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Chatbot Setting", route: "/Dashboard/help" },
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        {/* <!-- SIDEBAR HEADER --> */}
        <div className="flex items-center justify-between gap-2 pr-20 pl-2 py-2">
          <Link href="/Dashboard">
            <Image
              width={176}
              height={32}
